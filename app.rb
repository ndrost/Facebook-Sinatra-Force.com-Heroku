...
unless ENV["SFDC_OAUTH_CLIENT_ID"] && ENV["SFDC_OAUTH_CLIENT_SECRET"] && ENV["USERNAME"] && ENV["PASSWORD"]
  abort("missing env vars: please set SFDC_OAUTH_CLIENT_ID, SFDC_OAUTH_CLIENT_SECRET, USERNAME and PASSWORD with your app credentials")
end
...
before do
  ...
  @force_client = OAuth2::Client.new(
      ENV['SFDC_OAUTH_CLIENT_ID'],
      ENV['SFDC_OAUTH_CLIENT_SECRET'], 
